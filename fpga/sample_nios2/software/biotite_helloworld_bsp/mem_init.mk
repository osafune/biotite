...
# Memory: boot_flash
MEM_0 := boot_onchip_flash
$(MEM_0)_NAME := boot_flash
...
$(MEM_0)_END := 0x0f0167ff
$(MEM_0)_SPAN := 0x00016800
$(MEM_0)_HIERARCHICAL_PATH := boot_flash
$(MEM_0)_WIDTH := 32
...
$(HDL_SIM_DIR)/$(MEM_0).dat: $(MEM_0).flash
	...
	$(FLASH2DAT) --infile=$< --outfile=$@ \
		--base=0x0 --end=0x167ff --width=$(mem_width) \
...
.PHONY: boot_flash
boot_flash: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym $(MEM_0).flash

# Memory: onchip_memory2_0
MEM_1 := nios2core_onchip_memory2_0
